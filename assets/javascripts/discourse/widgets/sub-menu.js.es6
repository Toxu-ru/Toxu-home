...
var vtt_g_q = vtt_g.toFixed();
var vtt_c = 24 - vtt_g;	  
var oct = vtt_c.toFixed(); 
var ugol =  vtt_g_q*100;
...
if (t_day > 0) { var vrema = 'day'; var vrema_t = vtt_g_q; var grad = ugol; var t_op = 'д.';  var t_ops = 'осталось до следующего<br> дня ~ ' + oct +' ч.<br>';}	  
