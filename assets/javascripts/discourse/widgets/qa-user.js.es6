...
if (yes) { } else {  contents.push( new RawHtml({ html: `<div class="bd"><br><br><center> <span class="no"> Сертификата нет.</span> <br> <a href="https://toxu.ru/t/pochemu-mne-pishet-kakoj-to-bot/2294">Посмотреть, как получить сертификат.<a> </center></div>`}));  }
